...
(define sys:access-f-ok sys:F_OK)
(define sys:access-x-ok sys:X_OK)
(define sys:access-w-ok sys:W_OK)
(define sys:access-r-ok sys:R_OK)

(define sys:read-only  sys:O_RDONLY)
(define sys:write-only sys:O_WRONLY)
(define sys:read+write sys:O_RDWR)
...
(define sys:seek-set sys:SEEK_SET)
(define sys:seek-cur sys:SEEK_CUR)
(define sys:seek-end sys:SEEK_END)
...
(define sys:s-isuid sys:S_ISUID)
(define sys:s-isgid sys:S_ISGID)
(define sys:s-isvtx sys:S_ISVTX)
(define sys:s-irwxu sys:S_IRWXU)
(define sys:s-irusr sys:S_IRUSR)
(define sys:s-iwusr sys:S_IWUSR)
(define sys:s-ixusr sys:S_IXUSR)
(define sys:s-irwxg sys:S_IRWXG)
(define sys:s-irgrp sys:S_IRGRP)
(define sys:s-iwgrp sys:S_IWGRP)
(define sys:s-ixgrp sys:S_IXGRP)
(define sys:s-irwxo sys:S_IRWXO)
(define sys:s-iroth sys:S_IROTH)
(define sys:s-iwoth sys:S_IWOTH)
(define sys:s-ixoth sys:S_IXOTH)
